...
type keyMap struct {
	...
	Delete             key.Binding
	Add                key.Binding
	SetDefaultProject  key.Binding
	SetDefaultTerminal key.Binding
	Quit               key.Binding
...
func (k keyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		...
		{k.Tab, k.Enter, k.Add, k.Delete, k.SetDefaultProject, k.SetDefaultTerminal, k.Details},
		{k.Help, k.Quit},
	}
}
...
var keys = keyMap{
	...
	SetDefaultProject: key.NewBinding(
		key.WithKeys("p"),
		key.WithHelp("p", "set default project"),
	),
	SetDefaultTerminal: key.NewBinding(
		key.WithKeys("t"),
		key.WithHelp("t", "set default terminal"),
	),
	Help: key.NewBinding(
		key.WithKeys("?"),
